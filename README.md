...
Este repositorio contiene todas las prácticas, retos y evidencias desarrolladas durante la asignatura de Laboratorio de Elementos Programables I. Todo el hardware está basado en la **Raspberry Pi Pico 2 W**, programado en entornos de **MicroPython** y **C/C++**.
